...
const KonvaCanvas: Component = () => {
  ...
  const getCanvasMenuItems = (x: number, y: number): MenuItem[] => [
    ...
    { label: 'Add Decision', icon: '◇', onClick: () => addNodeAtPosition('decision', x, y) },
    { label: 'Add Junction', icon: '⊕', onClick: () => addNodeAtPosition('junction', x, y) },
  ...
  const getNodeMenuItems = (nodeId: string): MenuItem[] => [
    ...
    { label: 'Duplicate', icon: '📋', shortcut: 'Ctrl+D', onClick: duplicateSelectedNode },
